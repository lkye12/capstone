...
var apiRequest = function apiRequest() {
  _axios.default.get("https://api.nasa.gov/planetary/apod?api_key=khPLpN5zqP9OgtH0du57shLWaAsMwrNf85j25sSw").then(function (response) {
    var output = document.getElementById("Nasa");
    Object.keys(response);
    output.innerText = response.data;
    output.innerText = response.data.title;
...
apiRequest(); // Object.keys(response);
// const postPromise = fetch("https://api.nasa.gov/planetary/apod?api_key=khPLpN5zqP9OgtH0du57shLWaAsMwrNf85j25sSw");
// postPromise
//   .then((data) => data.json())
//   .then((data) => {
...
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js","axiosGet.js"], null)
